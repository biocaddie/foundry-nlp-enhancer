 ...
 * </ul>
 */
public class MetaMapLiteNew {
  /** log4j logger instance */
  private static final Logger logger = LogManager.getLogger(MetaMapLiteNew.class);
  ...
  Set<String> semanticGroup = SemanticGroups.getClinicalDisorders();
  ...
  public MetaMapLiteNew(Properties properties) 
	   ...
	   IOException
  {
    ...
    this.semanticGroup = SemanticGroups.getClinicalDisorders();
  }
    ...
    throws IllegalAccessException, InvocationTargetException, IOException, Exception
  {
    ...
    // find any user-defined abbreviations using abbrConverter
	...
	passageWithSentsAndAbbrevs, this.useContext, this.semanticGroup, new HashSet<String>())
       //)
       );
	   ...
	   Exception
  {
	...
	System.out.println("loaded " + localConfiguration.size() + " records from local configuration");
      ...
      MetaMapLiteNew metaMapLiteInst = new MetaMapLiteNew(properties);
	...
	Boolean.parseBoolean(properties.getProperty("metamaplite.usecontext"));
